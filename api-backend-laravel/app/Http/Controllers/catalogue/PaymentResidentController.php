...
use App\Models\schema_public\PaymentResident;
use Illuminate\Http\Request;
use App\Http\Controllers\Controller;

class PaymentResidentController extends Controller
{
    /**
    ...
    {
        return PaymentResident::orderBy('namepaymentresident', 'asc')->get();
    }
    ...
    {
        $item = PaymentResident::find($id);
        return $this->action($item, $request, 'update');
    }

    private function action(PaymentResident $item, Request $request, $typeAction)
    {
        $item->namepaymentresident = strtoupper($request->input('namepaymentresident'));
